...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO Projet (titre, description, date_de_debut, date_de_fin_prevue, budget, id_utilisateur) VALUES ('$titre', '$description', '$date_de_debut', '$date_de_fin_prevue', '$budget', '$user_id')";
    if (mysqli_query($conn, $query)) {
        ...
        if (!empty($_POST['task_title'])) {
            foreach ($_POST['task_title'] as $index => $task_title) {
                ...
                $user_check_query = "SELECT * FROM Utilisateur WHERE id_utilisateur='$task_user_id'";
                ...
                if (mysqli_num_rows($user_check_result) > 0) {
                    ...
                    echo "Erreur : L'utilisateur avec l'ID $task_user_id n'existe pas.";
                }
            }
        }
        ...
        header("Location: dashboard_chef_de_projet.php?message=Projet créé avec succès");
        exit();
    } else {
    ...
    <div class="container mt-5">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="date_de_fin_prevue" name="date_de_fin_prevue" required>
            </div>
            <div class="form-group">
                ...
                <div class="member-entry form-row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <select class="form-control" id="member_team_id[]" name="member_team_id[]" required>
                            ...
                            <?php while ($team = mysqli_fetch_assoc($team_result)): ?>
            ...
            <button type="submit" class="btn btn-success mt-4">Créer le Projet</button>
        </form>
